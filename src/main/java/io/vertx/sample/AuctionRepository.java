...
public class AuctionRepository {
    ...
    public void save(Auction auction) {
        LocalMap<String, String> auctionSharedData = sharedData.getLocalMap(auction.getId());
    ...
    public Optional<Auction> getById(String auctionId) {
        LocalMap<String, String> auctionSharedData = sharedData.getLocalMap(auctionId);
